...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // los alias más comunes para las clases de Edge
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${img5-min}", "click", function(sym, e) {
         window.open("1/p2_oa1_tronco.html", "_blank", "no,  width=958, height=538");
      ...
      Symbol.bindElementAction(compId, symbolName, "${img6-min}", "click", function(sym, e) {
         window.open("2/p2_oa1_tronco_2.html", "_blank", "no,  width=958, height=538");
      ...
      Symbol.bindElementAction(compId, symbolName, "${img7-min}", "click", function(sym, e) {
         window.open("3/p2_oa1_tronco_3.html", "_blank", "no,  width=958, height=538");
